        ...
        <div class="container">
            ...
            <div class="card" data-color="purple">
                ...
                <div class="card-content">
                    <h4>Total Earning</h4>
                    <h3>EG <?php echo number_format($totalEarning); ?></h3>
            ...
            <div class="card" data-color="orange">
                <div class="card-content">
                    ...
                    <h3>EG <?php echo number_format($todaysEarning); ?></h3>
            ...
            <div class="card" data-color="green">
                <div class="card-content">
                    ...
                    <p class="<?php echo $totalReservationsChange > 0 ? 'positive' : 'negative'; ?>">
                        <?php echo $totalReservationsChange > 0 ? '▲' : '▼'; ?>
                        <?php echo abs($totalReservationsChange); ?>%
                    </p>
                </div>
        ...
        LIMIT 6";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>EG ' . htmlspecialchars($row["grand_total"]) . '</td>';
                        echo '<td>';
            ...
            const datasets = ratings.map(rating => {
                return {
                    ...
                    data: labels.map(date => {
                        const entry = data.find(item => item.review_date === date && item.rating ==
                            rating);
